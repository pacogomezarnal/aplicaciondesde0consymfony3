 ...
 * Usuario
 *
 * @ORM\Table(name="barpaco_usuario")
 * @ORM\Entity(repositoryClass="TapasBundle\Repository\UsuarioRepository")
 */
class Usuario implements UserInterface
{
     ...
     * Add reserva
     *
     * @param \TapasBundle\Entity\Reserva $reserva
     *
     * @return Usuario
     */
    public function addReserva(\TapasBundle\Entity\Reserva $reserva)
    {
     ...
     * @param \TapasBundle\Entity\Reserva $reserva
     */
    public function removeReserva(\TapasBundle\Entity\Reserva $reserva)
    {
